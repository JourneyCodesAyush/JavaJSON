 ...
 * <p>
 * Converts a raw JSON string into a list of {@link Token} objects
 * for consumption by the
 * {@link io.github.journeycodesayush.javajson.parser.Parser}.
 * </p>
 */
public class Lexer {
    ...
    /**
     * Scans a keyword literal ({@code true}, {@code false}, {@code null})
     * and adds the corresponding token.
     *
     ...
     * @throws LexerError if the string is unterminated or contains an invalid
     *                    escape sequence
     */
    ...
    /**
     * Creates and throws a {@link LexerError} with the given message and current
     * line number.
     *
    ...
    /**
     * Scans a number literal (integer, decimal, or scientific notation)
     * and adds it as a {@link TokenType#NUMBER} token.
     *
