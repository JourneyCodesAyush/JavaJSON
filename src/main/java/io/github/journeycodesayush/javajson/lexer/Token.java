 ...
 *
 * <p>Each token captures the token type, the raw source text (lexeme), the evaluated literal value
 * (if any), and the line number where the token appears in the source.
 *
...
public record Token(TokenType type, String lexeme, Object literal, int line) {
  ...
  /**
   * Returns a formatted string representation of this token, showing the type, lexeme, literal, and
   * line number.
   *
  ...
  public String toString() {
    ...
    return String.format(
        ...
        type.toString(), displayLexeme, displayLiteral, line);
  }
}
